package br.com.microservices.statefulauthapi;
...
@SpringBootTest(classes = StatefulAuthApiApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT, properties = {
